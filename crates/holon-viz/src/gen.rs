...
pub fn manifest_loader() -> TypeRelationshipGraph {
    let nodes: Vec<crate::type_graph::TypeNode> = VizDomain::emit_nodes()
        .into_iter()
        .map(crate::type_graph::TypeNode::from)
        .collect();

    let relationships = vec![
        rel(
            "iso::VisualizationSpec",
            "iso::HasVisualization",
            TypeRelationshipKind::Implements,
        ),
        rel(
            "iso::VisualizationSpec",
            "iso::ZLayer",
        ...
        rel(
            "pipeline::PipelineState<Ingested>",
            "pipeline::PipelineState<Validated>",
            TypeRelationshipKind::AdvancesTo,
        ),
        rel(
            "pipeline::PipelineState<Validated>",
            "pipeline::PipelineState<Classified>",
        ...
        rel(
            "validation::CommitGate",
            "pipeline::PipelineState<NeedsReview>",
            TypeRelationshipKind::ValidatedBy,
        ),
        rel(
            "constraints::VendorConstraintSet",
            "constraints::ConstraintEvaluation",
            TypeRelationshipKind::Produces,
        ),
        rel(
            "constraints::InvoiceConstraintSolver",
            "constraints::InvoiceVerification",
            TypeRelationshipKind::Verifies,
        ),
        rel(
            "constraints::ConstraintEvaluation",
            "validation::Issue",
        ...
        rel(
            ...
            "constraints::ConstraintEvaluation",
            TypeRelationshipKind::Constrains,
        ),
        rel(
            "legal::Z3Result",
        ...
        rel(
            ...
            "ontology::ArtifactKind",
            TypeRelationshipKind::Contains,
        ),
        rel(
            "ontology::OntologySnapshot",
            "ontology::RelationKind",
            TypeRelationshipKind::Contains,
        ),
        rel(
            "ontology::RelationKind",
            "arc_kit_au::EvidenceGraph",
            TypeRelationshipKind::ProjectsTo,
        ),
        rel(
            "arc_kit_au::EvidenceGraph",
            "arc_kit_au::NodeType",
        ...
        rel(
            "arc_kit_au::SourceDoc",
            "arc_kit_au::ExtractedRow",
            TypeRelationshipKind::Produces,
        ),
        rel(
            "arc_kit_au::ExtractedRow",
            "arc_kit_au::Transaction",
            TypeRelationshipKind::Produces,
        ),
        rel(
            "arc_kit_au::Transaction",
        ...
        rel(
            "workbook::TxProjectionRow",
            "classify::TaxCategory",
            TypeRelationshipKind::ClassifiedAs,
        ),
        rel(
            "arc_kit_au::EvidenceGraph",
            "workbook::TxProjectionRow",
            TypeRelationshipKind::RecordsIn,
        ),
        rel(
            "zlayer::Document",
            "arc_kit_au::SourceDoc",
