...
- [Desktop Agent and Office Playbook Surface](./desktop-agent-office-playbook.md) - future MCPB, OneNote, SharePoint, and local simulation surface
...
The future desktop agent treats diagrams as versioned playbook artifacts that can be inserted into OneNote/Office or rendered in SharePoint. A diagram export is therefore more than a screenshot: it must carry a typed playbook model, render metadata, simulation profile, and evidence refs.
